...
const Cart = () => {
  ...
  return (
    <Container className='CartAll'>
      ...
      <Row>
        <Col xs={12} md={8} style={{ borderTop: "1px solid #a4a4a4", borderBottom: "1px solid #a4a4a4" }}>
          <div className='text-align-center empty-bag' style={{ display: "none" }}>
            <h2>카트가 비어있습니다.</h2>
            <div>상품을 담아주세요!</div>
          </div>
            ...
            <li className="cartListBox d-flex">
              ...
              <div className="cWrap d-flex">
                <div className="c_txt_box d-flex align-items-center">
                  <Col className="c_name" md={8}>아이스 아메리카노</Col>
                  <Col className="quan_box" md={2}>
                    <QuantityControl />
                  </Col>
                  <Col className="c_price" md={2}>4000원</Col>
                </div>
              </div>
            </li>
          </ul>
