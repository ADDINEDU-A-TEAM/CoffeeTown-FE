            ...
            <div>
                <Slider {...settings}>
                    <div>
                        ...
                        <h2 className="slideTxt slideTxt1">다양하게 준비된 <br/>특별한 원두와 로스팅</h2>
                    </div>
                    <div>
                        <img className="slideImg slideImg2" src={slideImg2} alt="slideImg2" title="slideImg2" />
                        <h2 className="slideTxt slideTxt2">따뜻하고 좋은 날 <br/> 커피타운과 함께</h2>
                    </div>
                    <div>
                        <img className="slideImg slideImg3" src={slideImg3} alt="slideImg3" title="slideImg3" />
                        <h2 className="slideTxt slideTxt3">커피의 맛과 향은 <br/>원두로 정해집니다.</h2>
                    </div>
                </Slider>
            </div>
        );
